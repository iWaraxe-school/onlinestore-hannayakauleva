...
public class CategoryDAO {
    ...
    static public void printStoreHierarchy() throws SQLException {
        Connection connection = ConnectionHelper.getInstance().getConnection();
        ...
        while (resultSet.next()) {
            ...
            ProductDAO.printProductsByCategory(categoryId);
        }
    }

    // Method prints all products sorted according to provided XML file
    static public void printStoreSort(Map<String, Sort> sortRule) throws SQLException {
        Connection connection = ConnectionHelper.getInstance().getConnection();
    ...
    static public void printStoreTop5() throws SQLException {
        Connection connection = ConnectionHelper.getInstance().getConnection();
